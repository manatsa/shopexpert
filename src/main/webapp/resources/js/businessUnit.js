...
$(document).ready(function () {
    bcontext=$('#context').val()
    initializeBUnitTable();
...
function initializeBUnitTable(){
    $.ajax({
        'url': `${bcontext}/units/list`,
        'method': "GET",
        'contentType': 'application/json'
    }).done(function (data) {
        createBUnitTable(data)
    });
...
function createBUnitTable(data){
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, node, config ) {
                    location.href=`${bcontext}/units-creation`
                }
            },
            {
                className:'bg-transparent',
        ...
        columns: [
            ...
            { 'data': 'id',
                ...
                "render": function (data) {
                    return `<a href="${bcontext}/units-creation?bUnitId=${data}" class="btn btn-outline-primary" ><i class="fa fa-pencil-square-o"></i></a>`
                } },
            { 'data': 'id',
                title: 'Trash',
                wrap: true,
