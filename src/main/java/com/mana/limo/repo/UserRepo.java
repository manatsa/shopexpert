...
public interface UserRepo extends CrudRepository<User, String> {
    ...
    @Query("Select Distinct u from User u "+ Constants.USER_CONSTANT+" where u.userType in:userTypes")
    public List<User> findByUserType(@Param("userTypes") List<UserType> userTypes);
    
    @Query("Select Distinct u from User u "+ Constants.USER_CONSTANT+" where u.userRoles in:userRoles")
