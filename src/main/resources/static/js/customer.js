...
$(document).ready(function () {
    $.ajax({
        'url': "/limousine/customers/list",
        'method': "GET",
        'contentType': 'application/json'
    }).done(function (data) {
        supplierTable=$('#customerList').DataTable({
            data: data,
            "bFilter" : true,
            processing:true,
            ordering: true,
            ...
            buttons: [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href="/limousine/customers-creation"
                    }
                },
                {
                    className:'bg-transparent',
            ...
            columns: [
                ...
                { 'data': 'id',
                    ...
                    "render": function (data) {
                                return `<a href="/limousine/customers-creation?customerId=${data}" class="btn btn-outline-primary" ><i class="fa fa-pencil-square-o"></i></a>`
                } },
                { 'data': 'id',
                    title: 'Trash',
                    wrap: true,
    ...
    $('#customerList tbody').on('mouseenter', 'td', function () {
