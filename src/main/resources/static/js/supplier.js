            ...
            buttons: [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href="/limousine/suppliers-creation"
                    }
                },
                {
                    className:'bg-transparent',
            ...
            columns: [
                ...
                { 'data': 'id',
                    ...
                    "render": function (data) {
                                return `<a href="/limousine/suppliers-creation?supplierId=${data}" class="btn btn-outline-primary" ><i class="fa fa-pencil-square-o"></i></a>`
                } },
                { 'data': 'id',
                    title: 'Trash',
                    wrap: true,
