...
$(document).ready(function () {
    $.ajax({
        'url': "/limousine/organizations/list",
        'method': "GET",
            ...
            buttons: [
                {
                    ...
                    action: function ( e, dt, node, config ) {
                        location.href="/limousine/orgs-creation"
                    }
                },
                {
                    className:'bg-transparent',
            ...
            columns: [
                ...
                { 'data': 'id',
                    ...
                    "render": function (data) {
                                return `<a href="/limousine/orgs-creation?productId=${data}" class="btn btn-outline-primary" ><i class="fa fa-pencil-square-o"></i></a>`
                } },
                { 'data': 'id',
                    title: 'Trash',
                    wrap: true,
